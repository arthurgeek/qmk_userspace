...
#define _________________PT_COMBO_R1___________________ _______     , PT_CAO     , _______, _______, _______
#define _________________PT_COMBO_R2___________________ _______     , PT_CA_TILDE, PT_COES, _______, _______
#define _________________PT_COMBO_R3___________________ PT_C_CEDILLA, _______    , _______, _______, _______
