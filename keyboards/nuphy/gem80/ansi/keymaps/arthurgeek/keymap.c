...
[_ALPHA] = LAYOUT_tkl_ansi(
	KC_ESC,   KC_BRMD, KC_BRMU, MAC_TASK, MAC_SEARCH, MAC_VOICE, MAC_DND, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, MAC_CONSOLE, MAC_PRTA, MAC_PRTO, MAC_LOCK,
...
[_FN] = LAYOUT_tkl_ansi(
	...
	_______,      _______,  _______,  _______,  _______, _______, MO(_NP_RGB), MO(_TOP_RGB),  RGB_SPD, RGB_SPI, _______, _______,                                               RGB_VAI,
